          ...
          ?>
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <span><a href="tr_info_index.php" class="btn btn-outline-warning">View Your
                                    Information</a></span>
         ...
         <strong>Success!</strong> Profile has been updated.
                ...
                ?>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-header">Upload New Lesson</div>
                                            <a href="" class="btn btn-outline-primary float-end" data-bs-toggle="modal"
                                                data-bs-target="#upload_file">Upload File</a></span>
                                        </div>
                                        <div class="card-body">
                                            <div class="d-flex flex-column align-items-center text-center">
                                                <!-- Modal -->
                                                <div class="modal fade" id="upload_file" tabindex="-1"
                                                    aria-labelledby="upload_file" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="upload_file">Upload New
                                                                    Lesson</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form action="../_actions/tr_upload_video_create.php" method="POST"
                  enctype="multipart/form-data">
                  <div class="mb-3">
            ...
            ?>
              ...
              ?>
                  ...
                  <div class="mb-3">
                   ...
                   <input type="file" name="file_name" class="form-control" id="exampleInputPassword1">
                  </div>
                  ...
                  <div class="modal-footer">
                   ...
                   <input type="submit" class="btn btn-primary" value="Upload New Video Lesson">
                                    ...
                                    <div class="modal-body">
                                        <form action="../_actions/tr_info_create.php" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="fix_address" class="form-control"
                                                    id="exampleInputPassword1">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <select name="program_id" class="form-select mt-3"
                        ...
                        ?>
                                            ...
                                            <select name="subject_id" class="form-select mt-3"
                                                aria-label="Default select example">
                                                <option selected>Open this select subject</option>
                                                <?php
                        $table = new SubjectTable(new MySQL());
