  ...
  <div id="layoutSidenav_content">
   <main>
    <div class="container-fluid px-4">
     <h1 class="mt-4">Registed Teacher Information Update Dashboard</h1>
     ...
     <div class="card mb-4">
      <div class="card-header">
       ...
       Registed Teacher Information Update <span><a href="tr_info_index.php"
         class="btn btn-outline-primary">Back</a></span>
      </div>
      <div class="card-body">
       <!-- add to datatable -->
       <form action="../_actions/tr_info_update.php" method="POST">
        <div class="mb-3">
        ...
        <input type="hidden" name="user_id" value="<?php if($teacher_edit->user_id) {
          echo $teacher_edit->user_id;
          } else {
          echo $auth->id;
          } ?>">
