  ...
  <div id="layoutSidenav_content">
   <main>
    <div class="container-fluid px-4">
     <h1 class="mt-4">Registed Teacher Information Detail Dashboard</h1>
     <ol class="breadcrumb mb-4">
      <li class="breadcrumb-item active"> Detail Dashboard</li>
     </ol>
     <?php //include("includes/top_card.php"); ?>
     <div class="card mb-4">
      <div class="card-header">
       <i class="fas fa-table me-1"></i>
       Registed Teacher Information Detail <span><a href="tr_info_index.php"
