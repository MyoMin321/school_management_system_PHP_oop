   ...
   <main>
    <div class="container-fluid px-4">
     ...
     <div class="alert alert-danger">
      <strong>Error!</strong> Teacher Information has not been updated.
     </div>
     <?php } ?>

     <?php if(isset($_GET['delsuccess'])) : ?>
     <div class="alert alert-success">
      <strong>Success!</strong> Teacher Information has been Deleted.
     </div>
     <?php endif; ?>

     <?php if(isset($_GET['addsuccess'])) : ?>
     <div class="alert alert-success">
      <strong>Success!</strong> Teacher Information has been Created New Record.
     </div>
     <?php endif; ?>
