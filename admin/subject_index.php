   ...
   <main>
    <div class="container-fluid px-4">
     ...
     <div class="alert alert-success">
      <strong>Success!</strong> Subject has been updated.
     </div>
     <?php } else if(isset($_GET['error']) && $_GET['error'] == true){ ?>
     <div class="alert alert-danger">
      <strong>Error!</strong> Subject has not been updated.
     </div>
     <?php } ?>
     ...
     <div class="alert alert-success">
      <strong>Success!</strong> Subject has been Created New Record.
     </div>
     <?php endif; ?>
       ...
       <table id="datatablesSimple">
        ...
        <tbody>
         ...
         <tr>
          ...
          <td>
           <?php if($auth->value == '3'){ ?>
           <a href="subject_edit.php?id=<?= $subject->id; ?>" class="btn btn-primary">Edit</a>
           <?php } ; ?>
           <a href="subject_detail.php?id=<?= $subject->id; ?>" class="btn btn-info">Show</a>
           <?php if($auth->value == '3') : ?>
           <a href="../_actions/subject_delete.php?id=<?= $subject->id; ?>" class="btn btn-danger">Delete</a>
           <?php endif; ?>
         </tr>
         <?php endforeach; ?>
        </tbody>
      ...
      <div class="modal-content">
       ...
       <div class="modal-body">
        <form action="../_actions/subject_create.php" method="POST">
         ...
         <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Subject Code</label>
          <input type="text" name="subject_code" class="form-control" id="">
         </div>
         <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <input type="submit" class="btn btn-primary" value="Create New Subject">
         </div>
        </form>
       </div>
